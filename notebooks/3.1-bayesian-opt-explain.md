...
The Python library used in this workshop (Optuna) [\(Akiba et al., 2019\)](http://arxiv.org/abs/1907.10902) relies on the *Tree-Structured Parzen Estimator* algorithm as its surrogate model. However, this algorithm is not detailed here; for more information, the reader may refer to [\(Watanabe, 2023\)](https://arxiv.org/abs/2304.11127).
